...
multiple_cfi_both_factors<- function(Yijbar,alpha,a,b,n,method,g,AnovaTable,factorA_col_1_1,
 ...
 print(paste("Tukey Factor A:",Tukey_a))
 print(paste("Tukey Factor B:",Tukey_b))
 ...
 compare_methods <- data.frame("Methods" = c("Bonferroni","Tukey Factor A","Tukey Factor B","Scheffe","Scheffe-Bonferroni Factor A","Scheffe-Bonferroni Factor B"),"Multipliers" = c(B,Tukey_a,Tukey_b,Scheffe,Scheffe_Bonferroni_a,Scheffe_Bonferroni_b)) 
...
CI_s_AgeGroup$CI_a %>% 
   kable(caption = "Factor A: Age Group Confidence Intervals") %>% 
   kable_styling(bootstrap_options = "striped",full_width = FALSE,position = "center")

CI_s_AgeGroup$CI_b %>% 
   kable(caption = "Factor B: Age Group Confidence Intervals") %>% 
   kable_styling(bootstrap_options = "striped",full_width = FALSE,position = "center")


multiple_cfi_one_factor <- function(Yijbar,alpha,a,b,n,method,g,AnovaTable,factorA,factorB,data,col_1_1,col_2_1,col_2,factor_considered){

 rows_col_list <- list(col_1_1,col_2_1,col_2)
...
rownames(CI_s) <- pmap_chr(rows_col_list,~paste0("u",..1,..3,"-","u",..2,..3)) 
...
CI_s_Sex <- multiple_cfi_one_factor(model_est_resid$Yijbar %>% t,0.05,6,2,52,"Tukey",6,AnovaTable,"AgeGroup","Sex",
                         COVID19,col_1_1_Sex,col_2_1_Sex,col_2_Sex,"factorB")
